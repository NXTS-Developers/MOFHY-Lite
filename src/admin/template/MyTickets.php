			...
			<table class="table table-stripped">
				...
				?>
					<tr>
						...
						?></td>
						<td><a href="<?php echo $AreaInfo['area_url'];?>admin/viewticket.php?ticket_id=<?php echo $TicketInfo['ticket_unique_id'];?>#reply" class="btn btn-sm btn-<?php echo $btn[0] ?> btn-rounded"><i class="fa fa-<?php echo $btn[1] ?>"></i> Manage</a></td>
					</tr>
					<?php
							}
						} else {
