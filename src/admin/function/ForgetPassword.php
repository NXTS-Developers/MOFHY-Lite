...
if(isset($_POST['reset'])){
	...
	if(mysqli_num_rows($sql)>0){
		...
		$TokenId = password_hash($Data['admin_key'], PASSWORD_DEFAULT);
		...
		$Body = "
			...
			<h3>Hi ".$Data['admin_fname'].",</h3><p>You have requested a password reset if you have not requested a password reset please let us know opening a support ticket in our hosting clientarea.</p><br>
