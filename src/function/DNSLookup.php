...
if(isset($_POST['submit'])){
	...
	// A records
	$DNS_A = dns_get_record($FormData['domain'],DNS_A);
	...
	// AAAA records
	$DNS_AAAA = dns_get_record($FormData['domain'],DNS_AAAA);
	...
	// CNAME records
	$DNS_CNAME = dns_get_record($FormData['domain'],DNS_CNAME);
	...
	// TXT records
	$DNS_TXT = dns_get_record($FormData['domain'],DNS_TXT);
	...
	// MX records
	$DNS_MX = dns_get_record($FormData['domain'],DNS_MX);
	...
	// NS records
	$DNS_NS = dns_get_record($FormData['domain'],DNS_NS);
	...
	// CAA records
	$DNS_CAA = dns_get_record($FormData['domain'],DNS_CAA);
	...
	// SOA records
	$DNS_SOA = dns_get_record($FormData['domain'],DNS_SOA);
	...
	echo '<th>Type</th>';
	echo '<th>TTL</th>';
	echo '<th>Primary NS</th>';
	echo '<th>Responsible Email</th>';
	echo '</thead>';
	if(count($DNS_SOA)>0){
