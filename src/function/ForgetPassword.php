...
if(isset($_POST['reset'])){
	...
	if(mysqli_num_rows($sql)>0){
		...
		$Body = "
			...
			<h3>Hi ".$Data['hosting_client_fname'].",</h3><p>You have requested a password reset. If you have not requested a password reset please let us know by opening a support ticket in the clientarea.</p><br>
