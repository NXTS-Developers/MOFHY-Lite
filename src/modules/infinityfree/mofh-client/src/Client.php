...
define('API_PLAN', $HostingApi['api_package']);
define('API_CPANEL_URL', $HostingApi['api_cpanel_url']);
define('API_SERVER_IP', $HostingApi['api_server_ip']);
define('API_NS_1', $HostingApi['api_ns_1']);
define('API_NS_2', $HostingApi['api_ns_2']);
